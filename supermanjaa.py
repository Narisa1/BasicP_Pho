...
def show_movies(movie_list):
    ...
    for movies01 in movie_list:
        print(movies01["movie_name"],movies01["ticket_price"])
...
# ฟังก์ชันสำหรับการซื้อบัตรชมหนัง 2
...
def main():
    ...
    while movies_start:
        print("แสดงหนัง[1]")
        print("ซื้อตั๋ว[2]")
        x = int(input("ดูรายการหนังหรือซื้อตั๋ว :"))
